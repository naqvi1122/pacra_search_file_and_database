...
.my-class {
    display: flex;width: 100%;height: 90vh;justify-content: center;align-items: center;
}
.my-class > form {
...
.my-class > form input {
    padding: 10px 20px;font-size: 18px;font-weight: bold;border-radius: 8px;border: solid #d4d4d4 1px;
    width: 500px;
    box-shadow: 2px 2px 4px #d4d4d4;

}

.my-class > form button {
    margin-top: 20px;padding: 10px;border-radius: 4px;align-self: center;font-size: 16px;background-color: #444;
    color: #fff;
}
